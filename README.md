...
**The .bat file will create a virtual environment in your project directory and install the required python version and associated packages(including gdsfactory).**
